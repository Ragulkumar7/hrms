...
const TeamLeadDashboard = ({ allTasks, setAllTasks, addNewTask }) => {
  ...
  // Editable Attendance State for Team
  ...
  // UI STYLES FOR FULL PAGE OCCUPANCY
  const cardStyle = {
    background: "white",
    padding: "20px",
    borderRadius: "15px",
  ...
  return (
    ...
    >
      <Sidebar />
      {/* MAIN CONTENT Area - Stretch to 100% width */}
      <div
      ...
      >
        ...
        {/* 3-Column Grid stretched to 100% */}
        <div
          style={{
            display: "grid",
        ...
        >
          <div style={{ ...cardStyle, background: "#f97316", color: "white" }}>
            ...
            >
              <p>
                <b>Name:</b> {tlProfile.name}
              </p>
              <p>
                <b>Role:</b> {tlProfile.role}
              </p>
              <p>
                <b>Email:</b> {tlProfile.email}
              </p>
            </div>
          </div>
          ...
          <div style={cardStyle}>
            <h3>
              <Clock color="#f97316" size={20} /> Attendance & Verification
            </h3>
            <div
              style={{
                textAlign: "center",
          ...
          <div style={cardStyle}>
            <h3>
              <ClipboardList color="#f97316" size={20} /> Project Task Status
            </h3>
            <div
              style={{
                flex: 1,
          ...
          <div style={cardStyle}>
            <h3>
              <FileCheck color="#f97316" size={20} /> Task Approvals
            </h3>
            <div style={{ overflowY: "auto", maxHeight: "180px" }}>
              {allTasks
                .filter(
                  (t) => t.empName === "TL Manager" || t.type === "Manager",
                )
                .map((t) => (
                  <div
                    key={t.id}
                    style={{
                      padding: "10px",
                      background:
                        t.status === "Verified" ? "#f0fdf4" : "#f8fafc",
                      marginBottom: "10px",
                      borderRadius: "8px",
                    ...
                    >
                      <span
                        style={{
                          fontSize: "10px",
                          color:
                            t.status === "Verified" ? "#16a34a" : "#ea580c",
                          fontWeight: "700",
                        }}
                      >
          ...
          <div style={cardStyle}>
            <h3>
              <Cpu color="#f97316" size={20} /> IT Technical
            </h3>
            <div
              style={{
                display: "flex",
          ...
          <div style={{ ...cardStyle, background: "#fffaf0" }}>
            <h3>
              <Bell color="#f97316" size={20} /> Announcements
            </h3>
          ...
          <div style={cardStyle}>
            <h3>
              <FolderPlus color="#f97316" size={20} /> Project Grouping
            </h3>
            <input
              value={projectName}
          ...
          <div style={cardStyle}>
            <h3>
              <UserX color="#f97316" size={20} /> Monitoring
            </h3>
          ...
          <div style={cardStyle}>
            <h3>
              <CheckSquare color="#f97316" size={20} /> Assign Task
            </h3>
            <select
              value={selectedEmp}
          ...
          <div style={{ ...cardStyle }}>
            <h3>
              <PlusCircle color="#f97316" size={20} /> Personal Task
            </h3>
            <input
            ...
            <input
              type="date"
              value={selfTaskDate}
              onChange={(e) => setSelfTaskDate(e.target.value)}
              style={{
                padding: "10px",
                marginBottom: "8px",
                borderRadius: "8px",
